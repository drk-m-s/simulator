...
parser.add_argument("--in-tokens", default=128, type=int)
...
model     = transformers.AutoModelForCausalLM.from_pretrained("mistralai/Mistral-7B-Instruct-v0.3", token=your_token,device_map="auto", torch_dtype="auto")

print (model)

tokenizer = transformers.AutoTokenizer.from_pretrained("mistralai/Mistral-7B-Instruct-v0.3", token=your_token, use_fast=False)
layer_mapping = {
